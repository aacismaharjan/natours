...
exports.showAlert = exports.removeWishlist = exports.hideAlert = exports.addWishlist = void 0;
...
var addWishlist = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tour) {
    var data, _res$data, res, _error$response, _error$response$data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          showAlert('error', _context.t0 === null || _context.t0 === void 0 ? void 0 : (_error$response = _context.t0.response) === null || _error$response === void 0 ? void 0 : (_error$response$data = _error$response.data) === null || _error$response$data === void 0 ? void 0 : _error$response$data.message);
...
var removeWishlist = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tour) {
    var data, res, _error$response2, _error$response2$data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 9:
          ...
          showAlert('error', _context2.t0 === null || _context2.t0 === void 0 ? void 0 : (_error$response2 = _context2.t0.response) === null || _error$response2 === void 0 ? void 0 : (_error$response2$data = _error$response2.data) === null || _error$response2$data === void 0 ? void 0 : _error$response2$data.message);
  ...
  return function removeWishlist(_x2) {
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    var cor = [loc.coordinates[1], loc.coordinates[0]];
    myPoints.push([loc.coordinates[1], loc.coordinates[0]]);
    var newPopup = L.popup({
      closeOnClick: false,
      autoClose: false
    }).setContent("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          stripe = Stripe('pk_test_51MLgEhSAhxO87B7pgtK8ZCmaslO28CUnBrE7YmyY2zKm3drZGbQOmMT0WIaU1Gl1AUciJAy51xLbJZjU0eYEczZ500Br0rV6Oz'); // 1) Get the checkout session from API
          _context.next = 4;
...
Array.from(cards).map(function (card) {
  var addBtn = card.querySelector('.btn-add-wishlist');
  var removeBtn = card.querySelector('.btn-remove-wishlist');
  if (addBtn) {
    addBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var tourId;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            tourId = JSON.parse(card.dataset.tour);
            _context.next = 3;
            return (0, _alerts.addWishlist)(tourId);
          case 3:
            if (!_context.sent) {
              _context.next = 6;
              break;
  ...
  if (removeBtn) {
    removeBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var tourId;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            tourId = JSON.parse(card.dataset.tour);
            _context2.next = 3;
            return (0, _alerts.removeWishlist)(tourId);
          case 3:
            if (!_context2.sent) {
              _context2.next = 6;
              break;
...
if (mapBox) {
  ...
  (0, _mapbox.displayMap)(myLocations);
}
if (loginForm) {
  loginForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var email, password, actionBtn, data;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            email = document.getElementById('email').value;
            password = document.getElementById('password').value;
            actionBtn = document.querySelector("button[type='submit']");
            e.preventDefault();
            data = {
              email: email,
              password: password
...
if (signupForm) {
  signupForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
      var name, email, password, passwordConfirm, actionBtn, data;
